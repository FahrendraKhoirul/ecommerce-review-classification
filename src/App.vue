        ...
        <div class="flex-grow">
          <div class="px-4 py-6">
            <div class="flex gap-4 items-center justify-center">
              <img
                src="/ecommerce_review.svg"
                class="object-cover h-12 w-12"
                alt=""
              />
              <div class="text-justify">
                <h1 class="text-lg font-semibold leading-none mb-1">
                  E-commerce
                </h1>
              ...
              <!-- <li>
                <router-link :to="{ name: 'Model' }">
                  <a
                    href="javascript:void(0)"
                    :class="[
                      'flex items-center rounded-xl font-bold text-sm text-dark py-3 px-4 hover:bg-yellow-50',
