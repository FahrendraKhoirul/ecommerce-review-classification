	...
	<div class="px-20 py-12 bg-darker">
		<div class="pt-8 px-4 shadow-md bg-lightorange rounded-lg mb-7">
			<div class="flex px-10">
				<img src="../assets/ecommerce.png" class="object-cover h-48 w-48" alt="" />
				<div class="px-10">
					<h2 class="text-dark font-semibold text-3xl leading-relaxed">
						Classification of E-commerce Review Aspects using
						<span class="bg-orange rounded-md px-2 text-white">Neural Network</span>
					</h2>
		...
		<div class="grid grid-cols-3 gap-4 mb-6">
				...
				<div class="flex justify-between">
					...
					>
						...
						<div class="ps-2 text-xs font-normal">
							Please kindly wait, first run could take several time around 1 minute :)
						</div>
					</div>
					<button
			...
			<div class="shadow-md rounded-lg bg-white px-6 py-3 border border-orange">
				...
				<p class="font-semibold text-dark text-base mb-1">Here is the result:</p>
		...
		<div v-else>
			<div class="shadow-md rounded-lg bg-white p-6 mb-6">
				<h2 class="text-2xl font-semibold mb-4">
					Result
					<span v-text="time" class="text-gray-700 font-normal italic text-sm"></span
						...
						<div class="ml-4 mb-10">
							<ol class="relative text-gray-500 border-s border-gray-200">
								...
								<li class="mb-10 ms-6">
									...
									<h3 class="font-medium leading-tight text-dark">Preprocessing</h3>
									<p class="text-sm">
